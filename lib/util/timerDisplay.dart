...
class Dependencies {
  ...
  TextStyle textStyle = LogoTextStyle();
...
//  CountdownText({this.dependencies, this.seconds});
//  final Dependencies dependencies;
//  final int seconds;
//
//  CountdownTextState createState() =>
//      new CountdownTextState(dependencies: dependencies, seconds: seconds);
//}
//
//class CountdownTextState extends State<CountdownText> {
//  CountdownTextState({this.dependencies, this.seconds});
//  final Dependencies dependencies;
//
//}
